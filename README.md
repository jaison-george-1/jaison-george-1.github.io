The below project helps us understand the highly corelated relationship between sales (using the sales transactions table) and income (uses the customer table). 
